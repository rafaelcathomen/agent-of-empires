...
describe("matchShortcut behavior (no binding changed by the refactor)", () => {
  const cases: Array<{
    ...
    {
      name: "Meta+F (KeyF) -> sessionSearch (mac)",
      event: ev({ key: "f", code: "KeyF", metaKey: true }),
      mac: true,
      expected: "sessionSearch",
    },
    {
      name: "Ctrl+F (KeyF) -> no match on mac",
      event: ev({ key: "f", code: "KeyF", ctrlKey: true }),
      mac: true,
      expected: null,
    },
    {
      name: "Ctrl+F (KeyF) -> sessionSearch on other",
      event: ev({ key: "f", code: "KeyF", ctrlKey: true }),
      mac: false,
      expected: "sessionSearch",
    },
    {
      name: "sessionSearch fires inside an input (mod-scoped global)",
      event: ev({ key: "f", code: "KeyF", metaKey: true }),
      mac: true,
      isInput: true,
      expected: "sessionSearch",
    ...
    {
      name: "Mac Option+F (key 'ƒ', code KeyF, alt held) does NOT match",
      event: ev({ key: "ƒ", code: "KeyF", metaKey: true, altKey: true }),
      mac: true,
      expected: null,
    },
    {
